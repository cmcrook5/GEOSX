...
{
  GEOSX_ERROR( "Trying to pack data type (" << LvArray::system::demangleType< T >() << ") by index..." );
  return 0;
}
...
{
  GEOSX_ERROR( "Trying to unpack data type (" << LvArray::system::demangleType< T >() << ") by index..." );
  return 0;
}
...
{
  GEOSX_ERROR( "Trying to pack data type (" << LvArray::system::demangleType< T >() << ") on device..." );
  return 0;
}
...
{
  GEOSX_ERROR( "Trying to pack data type (" << LvArray::system::demangleType< T >() << ") by index on device..." );
  return 0;
}
...
{
  GEOSX_ERROR( "Trying to unpack data type (" << LvArray::system::demangleType< T >() << ") on device..." );
  return 0;
}
...
{
  GEOSX_ERROR( "Trying to unpack data type (" << LvArray::system::demangleType< T >() << ") by index on device..." );
  return 0;
}
