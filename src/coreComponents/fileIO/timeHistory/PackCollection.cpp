...
//      target.packByIndex( buffer, m_setsIndices[ collectionIdx ], false, false, events );
    }
  }
...
//    target.pack( buffer, false, false, events ); // TODO This is unclear: `Trying to pack data type (double) on device but type is not packable.`
  }
  m_setChanged = false;
